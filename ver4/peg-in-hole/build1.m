...
frame_speedup = 0; % **the higher this value, the slower it runs, if not 0
...
%             pause(0.5);
        ...
        fprintf("Frame %i / current time: %i",frameCount, obj.CurrentTime)
        % speed up running frames by specified 'frame_speedup' number
        if frame_speedup ~= 0
            offset = ceil(double(obj.FrameRate))-frame_speedup;
        else
            offset = ceil(double(obj.FrameRate))-13;
        end
        for i = 1:offset
            if hasFrame(obj)                
...
%             disp('new image set')
        ...
        if ssimVal1_prev1 ~= ssimVal1_prev2
            ssimVal1_prev2 = ssimVal1_prev1;
        end
        if ssimVal1 ~= ssimVal1_prev1
            ssimVal1_prev1 = ssimVal1;
        end
        ...
        if get(handles.roi1, 'Value') == 1.0 && ...
                ...
                get(handles.roi3, 'Value') == 0.0
            fprintf('\tssimVal1_prev2: %.5i, ssimVal1_prev1: %.5i, ssimVal1: %.5i, detected1: %i \n',ssimVal1_prev2, ssimVal1_prev1, ssimVal1, detected1)
            
            if ssimVal1_prev2 > 0.9795 && ssimVal1 < 0.979 && (ssimVal1_prev2>ssimVal1_prev1) && ...
                    (ssimVal1_prev1>ssimVal1) && (ssimVal1_prev2-ssimVal1 > 0.004) && detected1==0
                disp('started 1!')
            ...
            % END condition
            elseif detected1==1 && (abs(ssimVal1_prev1-ssimVal1_prev2)>0.001) && ( forceEnd1 == 1 || ...
                    (ssimVal1 > 0.98 && ((ssimVal1 - ssimVal1_prev2) > 0.033 || (ssimVal1 - ssimVal1_prev1) > 0.003)) || ...
                    ( ssimVal1 > 0.97 && (ssimVal1 > ssimVal1_prev1 && ssimVal1_prev1 > ssimVal1_prev2) )  ...
                    )
        ...
        if setROI2 == 1
            ...
            fprintf('\tssimVal2_prev2: %.5i, ssimVal2_prev1: %.5i, ssimVal2: %.5i, detected2: %i \n',ssimVal2_prev2, ssimVal2_prev1, ssimVal2, detected2)
            % START condition - ROI 2
            if ssimVal2_prev2 > 0.98 && ssimVal2 < 0.979 && (ssimVal2_prev2>ssimVal2_prev1) && ...
                    (ssimVal2_prev1>ssimVal2) && detected2==0
                disp('started 2!')
%             if (((diff2-prev_diff2)>50)&&ssimVal2<0.5)&&(detected2==0)
            ...
            elseif (ssimVal2 > 0.98 && detected2==1 && ...
                    ((ssimVal2 - ssimVal2_prev2) > 0.04 || (ssimVal2 - ssimVal2_prev1) > 0.003)) || ...
                    ( abs(round(ssimVal2,3)-round(ssimVal2_prev1,3))<0.002 && abs(round(ssimVal2_prev1,3)-round(ssimVal2_prev2,3))<0.002 && detected2==1)       
                disp('ended 2!')
                % set detected state to false 
                setGlobalDetected2(0);
                % update the status and heart rate readings
        ...
        if setROI3 == 1
            ...
            fprintf('\tssimVal3_prev2: %.5i, ssimVal3_prev1: %.5i, ssimVal3: %.5i, detected3: %i \n',ssimVal3_prev2, ssimVal3_prev1, ssimVal3, detected3)
            setROI2 = 0;         
            if ssimVal3_prev2 > 0.98 && ssimVal3 < 0.979 && (ssimVal3_prev2>ssimVal3_prev1) && ...
                    (ssimVal3_prev1>ssimVal3) && detected3==0
                disp('started 3!')
            ...
            % END condition
            elseif (ssimVal3 > 0.98 && detected3==1 && ...
                    ((ssimVal3 - ssimVal3_prev2) > 0.04 || (ssimVal3 - ssimVal3_prev1) > 0.003)) || ...
                    ( abs(round(ssimVal3,3)-round(ssimVal3_prev1,3))<0.002 && abs(round(ssimVal3_prev1,3)-round(ssimVal3_prev2,3))<0.002 && detected3==1)       
                disp('ended 3!')
